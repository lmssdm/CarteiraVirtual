...
class ConverterFragment : Fragment(R.layout.fragment_converter) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // Configura a ActionBar (opcional, para ter o título)
        (activity as? AppCompatActivity)?.supportActionBar?.title = getString(R.string.converter_recursos)
    ...
    private fun buscarCotacao(moedaOrigem: Moeda, moedaDestino: Moeda, valorOrigem: Double) {
        ...
        // Lógica do Bitcoin (exatamente como a sua)
